...
def roll_dice(num_rolls, dice=six_sided):
    ...
    total, flag = 0, False
    while num_rolls:
        num_rolls, reuslt = num_rolls - 1, dice()
        if reuslt == 1:
            flag = True
        else:
            total = total + reuslt
...
def tail_points(opponent_score):
    ...
    if opponent_score >= 10:
        i, j = opponent_score % 10, (opponent_score // 10) % 10
    else:
...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and  score1 < goal:
        # first
        if who == 0:
            cuurent_dice_num = strategy0(score0, score1)
            score0 = update(cuurent_dice_num, score0, score1, dice)
        else:
            cuurent_dice_num = strategy1(score1, score0)
            score1 = update(cuurent_dice_num, score1, score0, dice)
        # switch(Fist and Second)
        who = 1 - who
    # END PROBLEM 5
